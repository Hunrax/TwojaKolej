...
create table Trasa(
    ...
    Dlugosc char(11) check (Dlugosc in('0-50', '50-100', '100-200', '200-500', 'powyzej 500')) not null,
    Czas_Trwania char(11) check (Czas_Trwania in('0-1h', '1-3h', '3-5h', '5-10h', 'powyzej 10h')) not null
)
